...
public class MajorQueryResponse implements Marhallable {
	...
	public MajorQueryResponse majorBlockIndex(final long value) {
	...
	public MajorQueryResponse majorBlockTime(final java.time.OffsetDateTime value) {
	...
	public void setMinorBlocks(final MinorBlock[] value) {
	    this.minorBlocks = value;
	}

	public MajorQueryResponse minorBlocks(final MinorBlock[] value) {
