...
@JsonTypeName("DataEntryQueryResponse")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class DataEntryQueryResponse implements Marhallable {
	...
	public DataEntryQueryResponse entryHash(final byte[] value) {
	    setEntryHash(value);
	    return this;
	}
	public DataEntryQueryResponse entryHash(final String value) {
		try {
	...
	public DataEntryQueryResponse entry(final DataEntry value) {
	    setEntry(value);
	    return this;
	}
