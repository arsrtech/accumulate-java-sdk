...
// UnionValue: BTCLegacy

@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("BTCLegacySignature")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BTCLegacySignature implements Signature {
	public final SignatureType type = SignatureType.BTCLEGACY;
	...
	public BTCLegacySignature publicKey(final byte[] value) {
	    setPublicKey(value);
	    return this;
	}
	public BTCLegacySignature publicKey(final String value) {
		try {
	...
	public BTCLegacySignature signature(final byte[] value) {
	    setSignature(value);
	    return this;
	}
	public BTCLegacySignature signature(final String value) {
		try {
	...
	public BTCLegacySignature signer(final Url value) {
	    setSigner(value);
	    return this;
	}
	public BTCLegacySignature signer(final String value) {
	...
	public BTCLegacySignature signerVersion(final long value) {
	...
	public BTCLegacySignature timestamp(final long value) {
	    setTimestamp(value);
	    return this;
	}
	...
	public BTCLegacySignature vote(final VoteType value) {
	    setVote(value);
	    return this;
	}
	@JsonDeserialize(using = HexDeserializer.class)
	...
	public BTCLegacySignature transactionHash(final byte[] value) {
	    setTransactionHash(value);
	    return this;
	}
	public BTCLegacySignature transactionHash(final String value) {
		try {
