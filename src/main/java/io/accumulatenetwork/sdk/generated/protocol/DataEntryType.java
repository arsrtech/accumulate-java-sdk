...
public enum DataEntryType implements IntValueEnum {
    ...
    DataEntryType(final int value, final String apiName) {
        this.value = value;
    ...
    public static DataEntryType fromValue(final int value) {
    ...
    public static DataEntryType fromApiName(final String name) {
        for (final var type : values()) {
    ...
    @JsonCreator
    public static DataEntryType fromJsonNode(final JsonNode jsonNode) {
        for (final var type : values()) {
