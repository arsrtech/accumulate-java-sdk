...
public class BTCSignature implements Signature {
	...
	public BTCSignature publicKey(final byte[] value) {
	    setPublicKey(value);
	    return this;
	}
	public BTCSignature publicKey(final String value) {
		try {
	...
	public BTCSignature signature(final byte[] value) {
	    setSignature(value);
	    return this;
	}
	public BTCSignature signature(final String value) {
		try {
	...
	public BTCSignature signer(final Url value) {
	    setSigner(value);
	    return this;
	}
	public BTCSignature signer(final String value) {
	...
	public BTCSignature signerVersion(final long value) {
	...
	public BTCSignature timestamp(final long value) {
	    setTimestamp(value);
	    return this;
	}
	...
	public BTCSignature vote(final VoteType value) {
	    setVote(value);
	    return this;
	}
	@JsonDeserialize(using = HexDeserializer.class)
	...
	public BTCSignature transactionHash(final byte[] value) {
	    setTransactionHash(value);
	    return this;
	}
	public BTCSignature transactionHash(final String value) {
		try {
