...
public enum ObjectType implements IntValueEnum {
    UNKNOWN(0, "unknown"),
    ACCOUNT(1, "account"),
    ...
    ObjectType(final int value, final String apiName) {
        this.value = value;
    ...
    public static ObjectType fromValue(final int value) {
    ...
    public static ObjectType fromApiName(final String name) {
        for (final var type : values()) {
