...
public enum KeyPageOperationType implements IntValueEnum {
    ...
    KeyPageOperationType(final int value, final String apiName) {
        this.value = value;
    ...
    public static KeyPageOperationType fromValue(final int value) {
    ...
    public static KeyPageOperationType fromApiName(final String name) {
        for (final var type : values()) {
    ...
    @JsonCreator
    public static KeyPageOperationType fromJsonNode(final JsonNode jsonNode) {
        for (final var type : values()) {
