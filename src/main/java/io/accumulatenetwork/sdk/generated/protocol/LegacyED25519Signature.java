...
// UnionValue: LegacyED25519

@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("LegacyED25519Signature")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LegacyED25519Signature implements Signature {
	public final SignatureType type = SignatureType.LEGACY_ED25519;
	...
	public LegacyED25519Signature timestamp(final long value) {
	    setTimestamp(value);
	    return this;
	}
	...
	public LegacyED25519Signature publicKey(final byte[] value) {
	    setPublicKey(value);
	    return this;
	}
	public LegacyED25519Signature publicKey(final String value) {
		try {
	...
	public LegacyED25519Signature signature(final byte[] value) {
	    setSignature(value);
	    return this;
	}
	public LegacyED25519Signature signature(final String value) {
		try {
	...
	public LegacyED25519Signature signer(final Url value) {
	    setSigner(value);
	    return this;
	}
	public LegacyED25519Signature signer(final String value) {
	...
	public LegacyED25519Signature signerVersion(final long value) {
	...
	public LegacyED25519Signature vote(final VoteType value) {
	    setVote(value);
	    return this;
	}
	@JsonDeserialize(using = HexDeserializer.class)
	...
	public LegacyED25519Signature transactionHash(final byte[] value) {
	    setTransactionHash(value);
	    return this;
	}
	public LegacyED25519Signature transactionHash(final String value) {
		try {
    ...
    public byte[] marshalBinary() {
        ...
        if (!(this.publicKey == null || this.publicKey.length == 0)) {
            marshaller.writeBytes(3, this.publicKey);
        }
        if (!(this.signature == null || this.signature.length == 0)) {
            marshaller.writeBytes(4, this.signature);
        }
        if (!(this.signer == null)) {
            marshaller.writeUrl(5, this.signer);
        }
        if (!(this.signerVersion == 0)) {
            marshaller.writeUint(6, this.signerVersion);
        }
        if (!(this.vote == null)) {
