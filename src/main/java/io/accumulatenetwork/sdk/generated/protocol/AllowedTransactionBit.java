...
public enum AllowedTransactionBit implements IntValueEnum {
    UPDATE_KEY_PAGE(1, "updateKeyPage"),
    UPDATE_ACCOUNT_AUTH(2, "updateAccountAuth");

    private final int value;
    private final String apiName;

    AllowedTransactionBit(final int value, final String apiName) {
        this.value = value;
    ...
    public static AllowedTransactionBit fromValue(final int value) {
    ...
    public static AllowedTransactionBit fromApiName(final String name) {
        for (final var type : values()) {
    ...
    @JsonCreator
    public static AllowedTransactionBit fromJsonNode(final JsonNode jsonNode) {
        for (final var type : values()) {
