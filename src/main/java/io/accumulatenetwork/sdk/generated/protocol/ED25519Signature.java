...
@JsonTypeName("ED25519Signature")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ED25519Signature implements Signature {
	public final SignatureType type = SignatureType.ED25519;
	...
	public ED25519Signature publicKey(final byte[] value) {
	    setPublicKey(value);
	    return this;
	}
	public ED25519Signature publicKey(final String value) {
		try {
	...
	public ED25519Signature signature(final byte[] value) {
	    setSignature(value);
	    return this;
	}
	public ED25519Signature signature(final String value) {
		try {
	...
	public ED25519Signature signer(final Url value) {
	    setSigner(value);
	    return this;
	}
	public ED25519Signature signer(final String value) {
	...
	public ED25519Signature signerVersion(final long value) {
	...
	public ED25519Signature timestamp(final long value) {
	    setTimestamp(value);
	    return this;
	}
	...
	public ED25519Signature vote(final VoteType value) {
	    setVote(value);
	    return this;
	}
	@JsonDeserialize(using = HexDeserializer.class)
	...
	public ED25519Signature transactionHash(final byte[] value) {
	    setTransactionHash(value);
	    return this;
	}
	public ED25519Signature transactionHash(final String value) {
		try {
