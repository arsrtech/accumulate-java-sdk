...
public enum NetworkType implements IntValueEnum {
    DIRECTORY(1, "directory"),
    BLOCK_VALIDATOR(2, "blockValidator");

    private final int value;
    private final String apiName;

    NetworkType(final int value, final String apiName) {
        this.value = value;
    ...
    public static NetworkType fromApiName(final String name) {
        for (final var type : values()) {
    ...
    @JsonCreator
    public static NetworkType fromJsonNode(final JsonNode jsonNode) {
        for (final var type : values()) {
