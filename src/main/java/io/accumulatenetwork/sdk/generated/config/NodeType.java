...
public enum NodeType implements IntValueEnum {
    ...
    NodeType(final int value, final String apiName) {
        this.value = value;
    ...
    public static NodeType fromValue(final int value) {
    ...
    public static NodeType fromApiName(final String name) {
        for (final var type : values()) {
    ...
    @JsonCreator
    public static NodeType fromJsonNode(final JsonNode jsonNode) {
        for (final var type : values()) {
